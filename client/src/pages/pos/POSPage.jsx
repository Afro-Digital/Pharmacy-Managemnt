    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white p-3.5 rounded-2xl border border-slate-200/80 shadow-xs">
        ...
        <div className="flex items-center space-x-2">
            ...
            <div className="flex items-center bg-slate-100 p-1 rounded-xl border border-slate-200 text-xs font-semibold">
              <button
                ...
                className={`px-3 py-1.5 rounded-lg transition-all ${
                  adminMode === 'PHARMACIST' ? 'bg-white text-blue-700 shadow-xs' : 'text-slate-600'
                }`}
              >
                Pharmacist Mode
              </button>
              <button
                ...
                className={`px-3 py-1.5 rounded-lg transition-all ${
                  adminMode === 'CASHIER' ? 'bg-white text-blue-700 shadow-xs' : 'text-slate-600'
                }`}
              >
                Cashier Queue Mode
              </button>
          ...
          {activeMode === 'CASHIER' && (
            <Button variant="outline" size="sm" onClick={fetchPendingOrders} isLoading={queueLoading}>
          ...
          <div className="flex-1 flex flex-col space-y-3 min-w-0">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 shadow-xs"
              />
            </div>
